...
class GePGBill extends Model
{
    ...
    protected $dates = ['expires_at', 'academic_year'];
    protected $fillable = ['student_id', 'fee_collection_id', 'control_number', 'amount', 'bill_description', 'status', 'expires_at', 'academic_year'];
