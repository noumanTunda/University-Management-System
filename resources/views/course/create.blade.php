          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{URL::route("course.store")}}" method="post">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="code">Course Code <span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="duration_years">Duration (Years) <span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="ln_solid" style="margin-top: 30px; margin-bottom: 30px;"></div>
                ...
                <div class="form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                    ...
                    <button type="submit" class="btn btn-success" style="padding-left: 25px; padding-right: 25px;">Submit Course</button>
                  </div>
                </div>
