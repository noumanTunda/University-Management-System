...
@section('content')
<div class="row"><div class="col-md-12"><ol class="breadcrumb"><li><a href="{{URL::route('user.dashboard')}}">Dashboard</a></li><li class="active">Subject Assignment</li></ol></div></div>
